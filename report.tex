...
The work presented had emphasis on making it easier for the ordinary to understand the usually abstract concept of generic programming.
Therefore, a detailed tutorial on how to build described types with a gentle learning curve was presented, and the practical examples were used to show how it was possible to build suitable generic algorithms.
Furthermore, a procedure was provided to convert ordinary datatype declarations to described types, which makes it easier for an ordinary programmer to use possible library provided generic programs without much effort.
...
While the algorithm lacked an implementation, and thus it was hard to do precise benchmarking; a manual application of the algorithm to an indexed dependently-typed datatype showed that it was possible to eliminate almost all additional space and runtime overhead caused by the description encoding.
...
They always had planned time to meet even though they had busy schedules, they always provided detailed feedback on my drafts, and they provided support via mail whenever I had questions.
