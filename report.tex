...
Since there are no explicit way to encode a choice between multiple constructor, a boolean argument \ttvar{isRight} is used to determine which constructor is specified.
...
The way to represent parameters is by having them as an argument to the description value, which allows them to be qualified over the whole description.
